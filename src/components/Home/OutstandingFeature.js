...
const OutstandingFeature = () => {
    ...
    return (
        <div className={classNames(styles.outstandingFeatureWrapper, {
                        ...
                        <div className={styles.tabContent}>
                            <CustomCarousel
                                ...
                                <div className={classNames(styles.contentWrapper)}>
                                    ...
                                    <div className={classNames(styles.descriptionGroup, styles.number16)}>
                                        <span><p>3</p></span>
                                        <p className={styles.description}>Tự thiết lập đề thi hoặc<br/> sử dụng mẫu từ
                                            TestBank</p>
                                    </div>
                                    <div className={classNames(styles.descriptionGroup, styles.number17)}>
                                        <span><p>4</p></span>
                                        <p className={styles.description}>Dễ dàng quản lý lớp học &<br/> học viên của
                                            mình
                                        </p>
                                    </div>
                                    <div className={classNames(styles.descriptionGroup, styles.number18)}>
                                        <span><p>5</p></span>
                                        <p className={styles.description}>Nắm được toàn bộ tình <br/> trạng học tập của
                                            học
                                            viên</p>
                                    </div>
                                </div>
